About natten-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/natten-feedstock/blob/main/LICENSE.txt)

Home: https://natten.org/

Package license: MIT AND BSD-3-Clause

Summary: Neighborhood Attention Extension

Development: https://github.com/SHI-Labs/NATTEN
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/natten-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/natten-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `natten` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating natten-feedstock
=========================

If you would like to improve the natten recipe or build a new
...
Note that all branches in the conda-forge/natten-feedstock are
